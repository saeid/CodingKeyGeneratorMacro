...
let package = Package(
    ...
    products: [
        ...
        .executable(
            name: "CodingKeyGeneratorMacroClient",
            targets: ["CodingKeyGeneratorMacroClient"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .executableTarget(name: "CodingKeyGeneratorMacroClient", dependencies: ["CodingKeyGeneratorMacro"]),
